...
const theForm = document.querySelector('#cardDetails');
...
if (2000 + expYear < currentDate.getFullYear() || (2000 + expYear === currentDate.getFullYear() && expMonth <= (currentDate.getMonth()))
    ...
    displayError("Your card is valid!")
}
  
document.querySelector('#cardDetails').addEventListener('submit', submitHandler)
